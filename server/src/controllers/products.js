...
exports.getProducts = async (req, res, next) => {
  try {
    ...
    // Filter for published products if not admin
...
exports.getProduct = async (req, res, next) => {
  try {
    ...
    // Make sure only published products are returned for non-admins
...
exports.updateProduct = async (req, res, next) => {
  try {
    ...
    // Make sure user is product author or admin
...
exports.togglePublishStatus = async (req, res, next) => {
  try {
    ...
    if (product.author.toString() !== req.user.id && req.user.role !== 'admin') {
      return next(
        new ErrorResponse(`User ${req.user.id} is not authorized to modify this product`, 401)
      );
    }
